<div class="about">
  <div class="container">
    ...
    <div class="row about_row row-eq-height">
      ...
      <div class="col-lg-4">
        <div class="about_image"><img src="{!! asset('health/images/about_1.jpg') !!}" alt=""></div>
      </div>
    </div>
    <div class="row">
      <div class="col">
        <div class="button about_button ml-auto mr-auto"><a href="#"><span>Contactez nous</span><span>Contactez nous</span></a></div>
      </div>
    </div>
  </div>
</div>
