    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <div class="news_posts">
          ...
          <!-- News Post -->
          <div class="news_post">
            <div class="news_post_image"><img src="{!! asset('health/images/news_1.jpg') !!}" alt=""></div>
          ...
          <!-- News Post -->
          <div class="news_post">
            <div class="news_post_image"><img src="{!! asset('health/images/news_2.jpg') !!}" alt=""></div>
            <div class="news_post_content">
              <div class="news_post_date"><a href="#">17 April, 2018</a></div>
          ...
          <!-- News Post -->
          <div class="news_post">
            <div class="news_post_image"><img src="{!! asset('health/images/news_3.jpg') !!}" alt=""></div>
            <div class="news_post_content">
              <div class="news_post_date"><a href="#">17 April, 2018</a></div>
        ...
        <div class="news_sidebar">
          ...
          <div class="sidebar_search">
            <form action="#" id="sidebar_search" class="sidebar_search">
              <input type="text" class="sidebar_search_input" placeholder="Rechercher" required="required">
          ...
          <div class="sidebar_latest">
            <div class="sidebar_title">Informations</div>
